      ...
      "
        >
            ...
            <div className="relative mt-6 px-4">
                {/* Logo + app name */}
                <NextLink className="w-full flex flex-col items-center gap-2" href="/" onClick={handleDrawerClose}>
                    <motion.div
                        animate={{ y: [0, -5, 0] }}
                    ...
                    <div className="grid place-items-center">
                        <p className="font-extrabold tracking-wider text-lg">{app.name.toUpperCase()}</p>
